...
class MagneticCountingBoardView : AbstractBoardView {

    private var state = MagneticState() // Just for the preview during development
    ...
    fun configure(state: MagneticState) {
        this.state = state
        updateSummary()
        invalidate()
    }
